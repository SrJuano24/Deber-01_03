...
public class Cliente {
    ...
    public Cliente(int codigo, int sucursalAsignada, String nombre, String cedula, String direccion, String celular) {
        this.codigo = codigo;
        this.sucursalPerteneciente = sucursalAsignada;
        this.nombre = nombre;
        this.cedula = cedula;
    ...
    private String CedulaValida() {
        ...
        if (longitud == 10) {
            retorno = "Cedula Valido";

        } else {
            retorno = "Cedula Invalido";
        }
        return retorno;
    }
